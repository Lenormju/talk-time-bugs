...
<div class="relative h-96">
  <v-click>
    <div class="absolute w-72 top-2 left-4 rotate-[-3deg]">
  ...
  <v-click>
    <div class="absolute w-64 top-8 left-52 rotate-[5deg]">
  ...
  <v-click>
    <div class="absolute w-70 top-1 left-96 rotate-[-6deg]">
  ...
  <v-click>
    <div class="absolute w-68 top-24 left-20 rotate-[3deg]">
  ...
  <v-click>
    <div class="absolute w-60 top-28 left-64 rotate-[-4deg]">
  ...
  <v-click>
    <div class="absolute w-72 top-16 left-32 rotate-[7deg]">
